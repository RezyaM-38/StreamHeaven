...
<div class="carousel_block">
  ...
  <div class="myslide_fade">
    ...
    <img class="slider_img" src="007wallpaper.jpg" />
  </div>
  <!-- Slide 2 -->
  <div class="myslide_fade">
    <div class="txt">
    </div>
    <img class="slider_img" src="Spiderman.jpeg" />
  </div>
  <!-- Slide 3 -->
  <div class="myslide_fade">
    <div class="txt">
    </div>
    <img class="slider_img" src="avatar%20wallpaper.jpeg" />
  </div>
  <!-- Navigation Arrows -->
...
<div class="slider_container_recommander">
  ...
  <div class="slider_block">
    ...
    <div class="slide_image">
      <img src="ironman3.jpg" width="100%" height="100%">
    ...
    <div class="slide_image">
      <img src="F&Fx_cover.jpg" width="100%" height="100%">
      <input class="toggle-heart" id="like15" type="checkbox">
      <label for="like15" aria-label="like">❤</label>
    </div>

    <div class="slide_image">
      <img src="creedIIIjpg.jpg" width="100%" height="100%">
    ...
    <div class="slide_image">
      <img src="civilwar.jpg" width="100%" height="100%">
...
<div class="slider_container_recommander">
  ...
  <div class="slider_block">
    ...
    <div class="slide_image">
      <img src="joker.jpg" width="100%" height="100%">
    ...
    <div class="slide_image">
      <img src="champduloup.jpg"width="100%" height="100%">
      <input class="toggle-heart" id="like14" type="checkbox">
...
<footer>
  ...
  <div class="logo_footer_container">
    ...
    <a href="Film.php" title="StreamHeaven">
