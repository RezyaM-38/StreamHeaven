  ...
  <header>
    <div class="nav_bar_">
      ...
      <div class="deconnecter">
        <a href="S'identifier.php" class="bouton_deconnecter">Se Déconnecter</a>
      </div>
    </div>
  </header>
</main>
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div class="abonnement">
              ...
              <h6 class="my-0">Abonnement Offre Premium</h6>
              <small class="text-body-secondary">Sans engagement</small>
            </div>

            <span class="text-body-secondary">6.99 € / Mois</span>
          </li>
