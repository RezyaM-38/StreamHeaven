    ...
    <div class="row g-5">
        ...
        <ul class="list-group mb-3">
          <li class="list-group-item d-flex justify-content-between lh-sm">
            <div class="abonnement">
              ...
              <h6 class="my-0">Abonnement Offre Etudiante</h6>
              <small class="text-body-secondary">Sans engagement</small>
            </div>

            <span class="text-body-secondary">2.99 € / Mois</span>
          </li>
      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form class="needs-validation" novalidate>
          ...
          <hr class="my-4">
          <a href="Accueil.php">
          <button class="w-100 btn btn-primary btn-lg">Valider mon abonnement</button>
          </a>
        </form>
      </div>
    </div>
