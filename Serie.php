      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li><a href="recommandé1.php" class="nav-link px-2 link-body-emphasis">Recommandé</a></li>
          ...
          <div class="dropdown text-end">
            <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="pp1.png" alt="mdo" width="32" height="32" class="rounded-circle">
            </a>
            <ul class="dropdown-menu text-small">
              <a class="dropdown-item" href="recommandé2.php"><li class="burger"><img class="pp_nav" src="pp2.png">En Y</li></a>
...
<div class="carousel_block">
  ...
  <div class="myslide_fade">
    ...
    <img class="slider_img" src="casadepapelwallpaper.jpg" />
  </div>
  <!-- Slide 2 -->
  <div class="myslide_fade">
    <div class="txt">
    </div>
    <img class="slider_img" src="HD-wallpaper-top-boy.jpeg" />
  </div>
  <!-- Slide 3 -->
  <div class="myslide_fade">
    <div class="txt">
    </div>
    <img class="slider_img" src="thelastkingdom.jpeg" />
  </div>
  <!-- Navigation Arrows -->
...
<h3>Séries d'action et d'aventure</h3>
<div class="slider_container_recommander">
  <button class="arrow_left_recommander_arrow" id="Previous">&#8249;</button>
  ...
  <div class="slider_block">
    ...
    <div class="slide_image">
      <img src="tulsaking.jpg" width="100%" height="100%">
...
<h3>Séries à regarder sans modération</h3>
<div class="slider_container_recommander">
  <button class="arrow_left_recommander_arrow" id="Previous">&#8249;</button>
  ...
  <div class="slider_block">
    ...
    <div class="slide_image">
      <img src="newamsterdam.jpg" width="100%" height="100%">
...
<footer>
  ...
  <div class="logo_footer_container">
    ...
    <a href="Serie.php" title="StreamHeaven">
