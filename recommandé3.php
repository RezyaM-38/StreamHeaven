      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            <li><a href="recommandé3.php" class="nav-link px-2 link-body-emphasis">Recommandé</a></li>
          ...
          <div class="dropdown text-end">
            <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="pp3.jpg" alt="mdo" width="32" height="32" class="rounded-circle">
            </a>
...
<div class="carousel_block">
  ...
  <div class="myslide_fade">
    ...
    <img class="slider_img" src="vikings-wallpaper.jpeg" />
  </div>
  <!-- Slide 2 -->
  <div class="myslide_fade">
    <div class="txt">
    </div>
    <img class="slider_img" src="Montecristo.jpeg" />
  </div>
  <!-- Slide 3 -->
  <div class="myslide_fade">
    <div class="txt">
    </div>
    <img class="slider_img" src="the-walking-dead.jpeg" />
  </div>
  <!-- Navigation Arrows -->
...
<footer>
  ...
  <div class="logo_footer_container">
    <div class="logo_footer">
      <a href="recommandé3.php" title="StreamHeaven">
