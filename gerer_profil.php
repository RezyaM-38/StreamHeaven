...
<section class="gere_profil">

  <div class="block_gere">
    <div class="block_titre_gere">
      <h1 class="titre_gere">Gérer vos profils</h1>
      <p class="texte_gere">Modifier vos profils</p>
    </div>

    <div class="supprimer_profil">

      <div class="block_supprimer">
      <div class="profil1">
        <p class="supprimer_profil_texte"><img class="pp_nouveau" src="pp1.png">Mayzer</p>
      </div>
      ...
      <div class="profil2">
        ...
        <p class="supprimer_profil_texte"><img class="pp_nouveau" src="pp2.png">En Y</p>
        <div class="supprime2">
      ...
      <div class="profil3">
        ...
        <p class="supprimer_profil_texte"><img class="pp_nouveau" src="pp3.jpg">Sur le T-Max</p>
        <div class="supprime3">
